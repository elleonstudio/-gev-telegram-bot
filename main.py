...
async def run_audit(update: Update, text: str):
    system_audit = (
        ...
        "ПРАВИЛА:\n"
        "1. НЕ ПИШИ свои размышления ('Рассчитаем строку' и т.д.).\n"
        "2. В начале ответа ПОЛНОСТЬЮ СКОПИРУЙ исходный расчет пользователя.\n"
        "3. Если ОШИБОК НЕТ:\n"
        "Выведи исходный текст, затем пустую строку, затем: '✅ Ошибок нет, финальная сумма [X]֏ верна.'\n"
        "4. Если ОШИБКИ ЕСТЬ:\n"
        "Выведи исходный текст, затем '❌ Найдены ошибки в расчетах!', затем блоки 'Строка:', 'Сумма:', 'Расхождение:' с пустой строкой между ними. В конце — '✅ Исправленный расчет:'.\n"
        "Соблюдай отступы и дизайн пользователя."
    )
